        ...
        <div className="flex h-screen bg-background text-white overflow-hidden font-sans">
            ...
            <aside className="w-72 bg-surface border-r border-border flex flex-col flex-shrink-0 z-20">
                    ...
                    <div className="flex items-center gap-4">
                        ...
                        <div>
                            <h1 className="text-white font-bold text-xl leading-none tracking-tight flex items-center gap-2">
                                Admin<span className="text-yellow-500">SOC</span>
                                <span className="text-[9px] bg-yellow-500/20 text-yellow-500 border border-yellow-500/30 px-1.5 py-0.5 rounded-full font-bold">
                                    v1.3.0
                                </span>
                            </h1>
                ...
                <div className="p-6 border-t border-border">
                    ...
                    <p className="text-center text-gray-600 text-[10px] mt-4 font-mono">v.1.3.0 Admin</p>
                </div>
            </aside>
